...
GtkWidget *make_window(GHashTable *pointer_passer) {
    ...
    gtk_box_pack_start(GTK_BOX(hbox_file_choose), label_csv_file, FALSE, FALSE, 10);
    gtk_box_pack_start(GTK_BOX(hbox_file_choose), text_filename, FALSE, FALSE, 10);
    ...
    gtk_box_pack_start(GTK_BOX(hbox_headers_go), checkbox_has_headers, FALSE, FALSE, 10);
    gtk_box_pack_start(GTK_BOX(hbox_headers_go), button_go, FALSE, FALSE, 10);
    ...
    gtk_box_pack_start(GTK_BOX(hbox_close_copy), button_close, FALSE, FALSE, 10);
    gtk_box_pack_start(GTK_BOX(hbox_close_copy), button_copy, FALSE, FALSE, 10);
    ...
    gtk_box_pack_start(GTK_BOX(vbox_ui), hbox_file_choose, FALSE, FALSE, 10);
    gtk_box_pack_start(GTK_BOX(vbox_ui), hbox_headers_go, FALSE, FALSE, 10);
    gtk_box_pack_start(GTK_BOX(vbox_ui), scrolled_window, TRUE, TRUE, 10);
    gtk_box_pack_start(GTK_BOX(vbox_ui), hbox_table_name, FALSE, FALSE, 10);
    gtk_box_pack_start(GTK_BOX(vbox_ui), label_mysql_command, FALSE, FALSE, 10);
    gtk_box_pack_start(GTK_BOX(vbox_ui), hbox_close_copy, FALSE, FALSE, 10);
    gtk_box_pack_start(GTK_BOX(vbox_ui), status_bar, FALSE, FALSE, 10);
